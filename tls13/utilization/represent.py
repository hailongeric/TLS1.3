...
def chunks(seq, size):
    '''
    Generator that cuts bytes into chunks of given _size.
    If `seq` length is not multiply of `_size`, the lengh of the last chunk
